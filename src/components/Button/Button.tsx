...
export const buttonStyles = tv({
  ...
  variants: {
    intent: {
      default: {},
      primary: { base: 'bg-accent text-on-solid border-accent hover:bg-accent hover:brightness-[1.06]' },
      danger:  { base: 'bg-err text-on-solid border-err hover:bg-err hover:brightness-[1.06]' },
      success: { base: 'bg-ok text-on-solid border-ok hover:bg-ok hover:brightness-[1.06]' },
      warning: { base: 'bg-warn text-on-solid border-warn hover:bg-warn hover:brightness-[1.06]' },
  ...
  compoundVariants: [
    ...
    { intent: 'primary', loading: true, class: { loadingSpinner: 'text-on-solid' } },
    { intent: 'danger',  loading: true, class: { loadingSpinner: 'text-on-solid' } },
    { intent: 'success', loading: true, class: { loadingSpinner: 'text-on-solid' } },
    { intent: 'warning', loading: true, class: { loadingSpinner: 'text-on-solid' } },
